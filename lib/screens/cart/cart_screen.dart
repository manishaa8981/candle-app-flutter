                        ...
                        Container(
                          ...
                          child: Builder(builder: (context) {
                            ...
                            return Row(
                              ...
                              children: [
                                Container(
                                  child: Text("Total Items : ${total.toString()}", style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
                                ),
                                Container(
                                  child: Text("Total Price : ${total_price.toString()}",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold)),
                                ),
                              ],
                            );
                          }),
